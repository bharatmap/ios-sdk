...
#import "BharatMapsDefaultStyle.h"
#import "BharatMapsSettings.h"
#import "BharatMapsTileServerOptions.h"

@class BharatMapsSource;
@class BharatMapsLight;

NS_ASSUME_NONNULL_BEGIN

FOUNDATION_EXTERN BharatMaps_EXPORT BharatMapsExceptionName const BharatMapsInvalidStyleURLException;
FOUNDATION_EXTERN BharatMaps_EXPORT BharatMapsExceptionName const BharatMapsRedundantLayerException;
FOUNDATION_EXTERN BharatMaps_EXPORT BharatMapsExceptionName const BharatMapsRedundantLayerIdentifierException;
FOUNDATION_EXTERN BharatMaps_EXPORT BharatMapsExceptionName const BharatMapsRedundantSourceException;
FOUNDATION_EXTERN BharatMaps_EXPORT BharatMapsExceptionName const BharatMapsRedundantSourceIdentifierException;
...
/**
 ...
 > Note: Wait until the map style has finished loading before modifying a map's
    style via any of the ``BharatMapsStyle`` instance methods below. You can use the
    ``BharatMapsMapViewDelegate/mapView:didFinishLoadingStyle:`` or
    ``BharatMapsMapViewDelegate/mapViewDidFinishLoadingMap:`` methods as indicators
    that it's safe to modify the map's style.
 */
BharatMaps_EXPORT
@interface BharatMapsStyle : NSObject
 ...
 */
+ (NSArray<BharatMapsDefaultStyle *> *)predefinedStyles;

/**
 Returns default style
 */
+ (BharatMapsDefaultStyle *)defaultStyle;
 ...
 */
+ (nullable BharatMapsDefaultStyle *)predefinedStyle:(NSString *)withStyleName;
 ...
 * change is complete, observe the ``BharatMapsMapViewDelegate/mapView:didFinishLoadingStyle:`` method
 ...
 */
@property (nonatomic, strong) NSSet<__kindof BharatMapsSource *> *sources;

/**
 Values describing animated transitions to changes on a style's individual
 paint properties.
 */
@property (nonatomic) BharatMapsTransition transition;
...
/**
 ...
 @return An instance of a concrete subclass of ``BharatMapsSource`` associated with the
    given identifier, or `nil` if the current style contains no such source.
 */
- (nullable BharatMapsSource *)sourceWithIdentifier:(NSString *)identifier;

/**
 Adds a new source to the current style.

 > Note: Adding the same source instance more than once will result in a
    ``BharatMapsRedundantSourceException``. Reusing the same source identifier, even with
    different source instances, will result in a
    ``BharatMapsRedundantSourceIdentifierException``.

 > Note: Sources should be added in
    ``BharatMapsMapViewDelegate/mapView:didFinishLoadingStyle:`` or
    ``BharatMapsMapViewDelegate/mapViewDidFinishLoadingMap:`` to ensure that the map
    has loaded the style and is ready to accept a new source.

 @param source The source to add to the current style.
 */
- (void)addSource:(BharatMapsSource *)source;
 ...
 */
- (void)removeSource:(BharatMapsSource *)source;
 ...
 */
- (BOOL)removeSource:(BharatMapsSource *)source error:(NSError *__nullable *__nullable)outError;
 ...
 */
@property (nonatomic, strong) NSArray<__kindof BharatMapsStyleLayer *> *layers;

/**
 Returns a style layer with the given identifier in the current style.

 @return An instance of a concrete subclass of ``BharatMapsStyleLayer`` associated with
    the given identifier, or `nil` if the current style contains no such style
    layer.
 */
- (nullable BharatMapsStyleLayer *)layerWithIdentifier:(NSString *)identifier;

/**
 Adds a new layer on top of existing layers.

 > Note: Adding the same layer instance more than once will result in a
    ``BharatMapsRedundantLayerException``. Reusing the same layer identifer, even with
 ...
 @param layer The layer object to add to the map view. This object must be an
    instance of a concrete subclass of ``BharatMapsStyleLayer``.
 */
- (void)addLayer:(BharatMapsStyleLayer *)layer;
 ...
 */
- (void)insertLayer:(BharatMapsStyleLayer *)layer atIndex:(NSUInteger)index;
 ...
 */
- (void)insertLayer:(BharatMapsStyleLayer *)layer belowLayer:(BharatMapsStyleLayer *)sibling;
...
/**
 ...
 existing layer.
 */
- (void)insertLayer:(BharatMapsStyleLayer *)layer aboveLayer:(BharatMapsStyleLayer *)sibling;

/**
 Removes a layer from the map view.

 @param layer The layer object to remove from the map view. This object
 must conform to the ``BharatMapsStyleLayer`` protocol.
 */
- (void)removeLayer:(BharatMapsStyleLayer *)layer;
 ...
 */
- (nullable BharatMapsImage *)imageForName:(NSString *)name;
...
/**
 ...
 set the `iconImageName` property of an ``BharatMapsSymbolStyleLayer`` object to that
 name.
 ...
 Learn how to add images to your map using an ``BharatMapsStyle`` object.
 */
- (void)setImage:(BharatMapsImage *)image forName:(NSString *)name;
 ...
 */
@property (nonatomic, strong) BharatMapsLight *light;
...
/**
 An object whose contents are represented by an ``BharatMapsStyle`` object that you
 configure.
 */
@protocol BharatMapsStylable <NSObject>
