...
#import "BharatMapsActionJournalOptions.h"
#import "BharatMapsFoundation.h"

NS_ASSUME_NONNULL_BEGIN

/**
 The ``BharatMapsMapOptions`` object provides a way to set map properties for each instance
 */
BharatMaps_EXPORT
@interface BharatMapsMapOptions : NSObject
 ...
 */
@property (nonatomic, nonnull) BharatMapsActionJournalOptions *actionJournalOptions;
