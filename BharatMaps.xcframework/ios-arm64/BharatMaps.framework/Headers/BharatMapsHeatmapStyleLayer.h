...
/**
 An ``BharatMapsHeatmapStyleLayer`` is a style layer that renders a <a
 ...
 ``BharatMapsHeatmapStyleLayer`` object, or they can be
 ``BharatMapsHeatmapStyleLayer``, ``BharatMapsHeatmapStyleLayer``,
 ``BharatMapsHeatmapStyleLayer``, or ``BharatMapsHeatmapStyleLayer`` instances
 in an ``BharatMapsHeatmapStyleLayer`` or ``BharatMapsHeatmapStyleLayer``
 object.
 
 Consider accompanying a heatmap style layer with an
 ``BharatMapsHeatmapStyleLayer`` or ``BharatMapsHeatmapStyleLayer`` at high zoom
 levels. If you are unsure whether the point data in an
 ``BharatMapsHeatmapStyleLayer`` is dense enough to warrant a heatmap, you can
 alternatively cluster the source using the ``BharatMapsHeatmapStyleLayer``
 option and render the data using an ``BharatMapsHeatmapStyleLayer`` or
 ``BharatMapsHeatmapStyleLayer``.
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsHeatmapStyleLayer : BharatMapsVectorStyleLayer
...
*/
@property (nonatomic) BharatMapsTransition heatmapIntensityTransition;
...
*/
@property (nonatomic) BharatMapsTransition heatmapOpacityTransition;
...
*/
@property (nonatomic) BharatMapsTransition heatmapRadiusTransition;
