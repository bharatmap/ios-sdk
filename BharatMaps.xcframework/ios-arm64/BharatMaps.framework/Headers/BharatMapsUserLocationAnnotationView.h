...
/** View representing an ``BharatMapsUserLocation`` on screen. */
BharatMaps_EXPORT
@interface BharatMapsUserLocationAnnotationView : BharatMapsAnnotationView
 ...
 */
@property (nonatomic, readonly, weak, nullable) BharatMapsMapView *mapView;
 ...
 */
@property (nonatomic, readonly, weak, nullable) BharatMapsUserLocation *userLocation;
