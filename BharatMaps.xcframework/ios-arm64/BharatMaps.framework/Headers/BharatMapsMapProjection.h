...
*/
BharatMaps_EXPORT
@interface BharatMapsMapProjection : NSObject
 ...
 */
- (instancetype)initWithMapView:(BharatMapsMapView *)mapView;

/**
 A camera representing the current projection state
 */
@property (readonly, copy) BharatMapsMapCamera *camera;
...
/**
 ...
 > Note: ``BharatMapsMapView`` instance frame must not be changed since this projection is initialized,
        otherwise the calculation may be wrong.
 */
- (void)setCamera:(BharatMapsMapCamera *_Nonnull)camera withEdgeInsets:(UIEdgeInsets)insets;
...
/**
 ...
 > Note: ``BharatMapsMapView`` instance frame must not be changed since this projection is initialized,
     otherwise the calculation may be wrong.
 */
- (void)setVisibleCoordinateBounds:(BharatMapsCoordinateBounds)bounds edgePadding:(UIEdgeInsets)insets;
