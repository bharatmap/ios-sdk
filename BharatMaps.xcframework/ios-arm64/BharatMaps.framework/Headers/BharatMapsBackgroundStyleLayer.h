...
/**
 ...
 access it by getting the last item in the ``BharatMapsStyle/layers`` array.
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsBackgroundStyleLayer : BharatMapsStyleLayer
...
*/
@property (nonatomic) BharatMapsTransition backgroundColorTransition;
...
*/
@property (nonatomic) BharatMapsTransition backgroundOpacityTransition;
...
*/
@property (nonatomic) BharatMapsTransition backgroundPatternTransition;
