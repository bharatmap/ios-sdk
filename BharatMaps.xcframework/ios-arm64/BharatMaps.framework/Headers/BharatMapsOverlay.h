...
/**
 The ``BharatMapsOverlay`` protocol defines a specific type of annotation that represents
 ...
 */
@protocol BharatMapsOverlay <BharatMapsAnnotation>
 ...
 */
@property (nonatomic, readonly) BharatMapsCoordinateBounds overlayBounds;
 ...
 */
- (BOOL)intersectsOverlayBounds:(BharatMapsCoordinateBounds)overlayBounds;
