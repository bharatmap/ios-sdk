...
/**
 The ``BharatMapsTileServerOptions`` defines server properties such as URL etc...
 */
BharatMaps_EXPORT
@interface BharatMapsTileServerOptions : NSObject
 ...
 * Default styles.
 */
@property (nonatomic, retain) NSArray<BharatMapsDefaultStyle*>* defaultStyles;

/**
 * Default style
 */
@property (nonatomic, retain) BharatMapsDefaultStyle* defaultStyle;
