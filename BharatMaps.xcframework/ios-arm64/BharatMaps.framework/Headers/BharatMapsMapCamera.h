...
/**
 An ``BharatMapsMapCamera`` object represents a viewpoint from which the user observes
 some point on an ``BharatMapsMapView``.

 #### Related examples
 - <doc:BlockingGesturesExample>: learn how to use the
 ``BharatMapsMapViewDelegate/mapView:shouldChangeFromCamera:toCamera:`` method of ``BharatMapsMapViewDelegate`` to
 restrict panning.
 - *TODO:* Camera animation, learn how to create a camera that rotates
 around a central point.
 */
BharatMaps_EXPORT
@interface BharatMapsMapCamera : NSObject <NSSecureCoding, NSCopying>
...
/**
 ...
 @return A Boolean value indicating whether the two cameras are functionally
    equivalent.
 */
- (BOOL)isEqualToMapCamera:(BharatMapsMapCamera *)otherCamera;
