 ...
 */
typedef NS_ENUM(NSUInteger, BharatMapsAttributionInfoStyle) {
  /**
   Specifies a short attribution info style.
   */
  BharatMapsAttributionInfoStyleShort = 1,
  /**
   Specifies a medium attribution info style.
   */
  BharatMapsAttributionInfoStyleMedium,
  /**
   Specifies a long attribution info style.
   */
  BharatMapsAttributionInfoStyleLong
};
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsAttributionInfo : NSObject
...
/**
 ...
 Example: If the `style` property is set to ``BharatMapsAttributionInfoStyle/BharatMapsAttributionInfoStyleShort``
 ...
 */
- (NSAttributedString *)titleWithStyle:(BharatMapsAttributionInfoStyle)style;
