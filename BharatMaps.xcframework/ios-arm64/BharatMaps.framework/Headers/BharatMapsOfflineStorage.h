...
@class BharatMapsOfflinePack;
@protocol BharatMapsOfflineRegion;
@protocol BharatMapsOfflineStorageDelegate;

/**
 Posted by the shared ``BharatMapsOfflineStorage`` object when an ``BharatMapsOfflinePack``
 ...
 The `object` is the ``BharatMapsOfflinePack`` object whose progress changed. The
 `userInfo` dictionary contains the pack’s current state in the
 ``BharatMapsOfflinePackUserInfoKeyState`` key and details about the pack’s current
 progress in the ``BharatMapsOfflinePackUserInfoKeyProgress`` key. You may also consult
 the ``BharatMapsOfflinePack/state`` and ``BharatMapsOfflinePack/progress`` properties, which
 ...
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const NSNotificationName BharatMapsOfflinePackProgressChangedNotification;

/**
 Posted by the shared ``BharatMapsOfflineStorage`` object whenever an ``BharatMapsOfflineStorage``
 ...
 The `object` is the ``BharatMapsOfflinePack`` object that encountered the error. The
 `userInfo` dictionary contains the error object in the
 ``BharatMapsOfflinePackUserInfoKeyError`` key.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const NSNotificationName BharatMapsOfflinePackErrorNotification;

/**
 Posted by the shared ``BharatMapsOfflineStorage`` object when the maximum number of
 tiles has been downloaded and stored on the current device.

 The `object` is the ``BharatMapsOfflinePack`` object that reached the tile limit in the
 course of downloading. The `userInfo` dictionary contains the tile limit in the
 ``BharatMapsOfflinePackUserInfoKeyMaximumCount`` key.

 Once this limit is reached, no instance of ``BharatMapsOfflinePack`` can download
 ...
 */
typedef NSString *BharatMapsOfflinePackUserInfoKey NS_EXTENSIBLE_STRING_ENUM;
...
/**
 ...
 ``BharatMapsOfflinePackProgressChangedNotification`` notification. Call `-integerValue`
 on the object to receive the ``BharatMapsOfflinePackState``-typed state.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsOfflinePackUserInfoKey BharatMapsOfflinePackUserInfoKeyState;
...
/**
 ...
 ``BharatMapsOfflinePackProgressChangedNotification`` notification. Call
 `-BharatMapsOfflinePackProgressValue` on the object to receive the
 ``BharatMapsOfflinePackProgress``-typed progress.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsOfflinePackUserInfoKey BharatMapsOfflinePackUserInfoKeyProgress;
...
/**
 ...
 an ``BharatMapsOfflinePackErrorNotification`` notification. The error’s domain is
 ``BharatMapsErrorDomain``. See ``BharatMapsErrorDomain`` for possible error codes.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsOfflinePackUserInfoKey BharatMapsOfflinePackUserInfoKeyError;
...
/**
 ...
 limit.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsOfflinePackUserInfoKey BharatMapsOfflinePackUserInfoKeyMaximumCount;

FOUNDATION_EXTERN BharatMaps_EXPORT BharatMapsExceptionName const BharatMapsUnsupportedRegionTypeException;
 ...
 */
typedef void (^BharatMapsOfflinePackAdditionCompletionHandler)(BharatMapsOfflinePack *_Nullable pack,
 ...
 */
typedef void (^BharatMapsOfflinePackRemovalCompletionHandler)(NSError *_Nullable error);
 ...
 */
typedef void (^BharatMapsBatchedOfflinePackAdditionCompletionHandler)(
    NSURL *fileURL, NSArray<BharatMapsOfflinePack *> *_Nullable packs, NSError *_Nullable error);
...
*/
typedef void (^BharatMapsOfflinePreloadDataCompletionHandler)(NSURL *url, NSError *_Nullable error);

/**
 The type of resource that is requested.
 */
typedef NS_ENUM(NSUInteger, BharatMapsResourceKind) {
  /** Unknown type */
...
/**
 BharatMapsOfflineStorage implements a singleton (shared object) that manages offline
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsOfflineStorage : NSObject

/**
 Returns the shared offline storage object.
 */
@property (class, nonatomic, readonly) BharatMapsOfflineStorage *sharedOfflineStorage;
...
/**
 ...
 or endpoints.
 */
@property (nonatomic, weak, nullable) IBOutlet id<BharatMapsOfflineStorageDelegate> delegate;
...
/**
 ...
 `BharatMapsOfflineStorageDatabasePath`
...
/**
 ...
 To customize this path, specify the
 `BharatMapsOfflineStorageDatabasePath` key in Info.plist, see <doc:Info.plist_Keys>.
 */
...
- (void)addContentsOfFile:(NSString *)filePath
    withCompletionHandler:(nullable BharatMapsBatchedOfflinePackAdditionCompletionHandler)completion;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSArray<BharatMapsOfflinePack *> *packs;
...
/**
 ...
 The pack has an initial state of ``BharatMapsOfflinePackState/BharatMapsOfflinePackStateInactive``. To begin
 downloading resources, call ``BharatMapsOfflinePack/resume`` on the pack from within
 the completion handler. To monitor download progress, add an observer for
 ``BharatMapsOfflinePackProgressChangedNotification``s about that pack.
 ...
 */
- (void)addPackForRegion:(id<BharatMapsOfflineRegion>)region
             withContext:(NSData *)context
       completionHandler:(nullable BharatMapsOfflinePackAdditionCompletionHandler)completion;
...
/**
 ...
 and use the ``BharatMapsOfflineStorage/reloadPacks`` method to obtain valid pointers to all the packs.
 ...
 */
- (void)removePack:(BharatMapsOfflinePack *)pack
    withCompletionHandler:(nullable BharatMapsOfflinePackRemovalCompletionHandler)completion;
...
- (void)invalidatePack:(BharatMapsOfflinePack *)pack
...
/**
 ...
 method is called, the pointer values of the ``BharatMapsOfflinePack`` objects in the
...
/**
 ...
 as part of an offline pack or due to caching during normal use of ``BharatMapsMapView``.
 */
...
/**
 ...
 ``BharatMapsOfflineStorage/preloadData:forURL:modificationDate:expirationDate:eTag:mustRevalidate:completionHandler:``
 method.
...
- (void)preloadData:(NSData *)data
     ...
     modificationDate:(nullable NSDate *)modified
       expirationDate:(nullable NSDate *)expires
                 eTag:(nullable NSString *)eTag
       mustRevalidate:(BOOL)mustRevalidate
    completionHandler:(nullable BharatMapsOfflinePreloadDataCompletionHandler)completion;

@end

/**
 The ``BharatMapsOfflineStorageDelegate`` protocol defines methods that a delegate of an
 ``BharatMapsOfflineStorage`` object can optionally implement to transform various types
 of URLs before downloading them via the internet.
 */
@protocol BharatMapsOfflineStorageDelegate <NSObject>
 ...
 */
- (NSURL *)offlineStorage:(BharatMapsOfflineStorage *)storage
     URLForResourceOfKind:(BharatMapsResourceKind)kind
                  withURL:(NSURL *)url;
