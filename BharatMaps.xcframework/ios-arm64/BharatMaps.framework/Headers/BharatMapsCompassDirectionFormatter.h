...
/**
 The ``BharatMapsCompassDirectionFormatter`` class provides properly formatted
 ...
 the user’s current location, use ``BharatMapsClockDirectionFormatter`` instead.
 */
BharatMaps_EXPORT
@interface BharatMapsCompassDirectionFormatter : NSFormatter
...
/**
 This method is not supported for the ``BharatMapsCompassDirectionFormatter`` class.
 */
