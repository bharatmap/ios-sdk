...
@interface BharatMapsMapView (IBAdditions)
...
// inspectables declared in BharatMapsMapView.h are always sorted before those in
// BharatMapsMapView+IBAdditions.h, due to ASCII sort order.
