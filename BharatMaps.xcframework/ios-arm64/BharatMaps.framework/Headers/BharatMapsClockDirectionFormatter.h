...
/**
 The ``BharatMapsClockDirectionFormatter`` class provides properly formatted descriptions
 ...
 irrespective of the user’s orientation, use ``BharatMapsCompassDirectionFormatter``
 instead.
 */
BharatMaps_EXPORT
@interface BharatMapsClockDirectionFormatter : NSFormatter
...
/**
 This method is not supported for the ``BharatMapsClockDirectionFormatter`` class.
 */
