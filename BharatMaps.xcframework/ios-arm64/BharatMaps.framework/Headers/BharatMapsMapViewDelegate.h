...
@class BharatMapsMapView;
@class BharatMapsUserLocationAnnotationViewStyle;
@class BharatMapView;
@class BharatMapsPoiResult;
@class BharatMapsBuildingNumberResult;
@class BharatMapsUPinResult;
...
/**
 ...
 require the ``BharatMapsMapView`` class to load data asynchronously, the map view calls
 ...
 */
@protocol BharatMapsMapViewDelegate <NSObject>
 ...
 */
- (BOOL)mapView:(BharatMapsMapView *)mapView
    shouldChangeFromCamera:(BharatMapsMapCamera *)oldCamera
                  toCamera:(BharatMapsMapCamera *)newCamera;
...
- (BOOL)mapView:(BharatMapsMapView *)mapView
    shouldChangeFromCamera:(BharatMapsMapCamera *)oldCamera
                  toCamera:(BharatMapsMapCamera *)newCamera
                    reason:(BharatMapsCameraChangeReason)reason;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView regionWillChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView
    regionWillChangeWithReason:(BharatMapsCameraChangeReason)reason
...
/**
 ...
 as ``BharatMapsMapView/setCamera:animated:``. This method can be called before
 ...
 */
- (void)mapViewRegionIsChanging:(BharatMapsMapView *)mapView;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView regionIsChangingWithReason:(BharatMapsCameraChangeReason)reason;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView regionDidChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView
    regionDidChangeWithReason:(BharatMapsCameraChangeReason)reason
                     animated:(BOOL)animated;
 ...
 */
- (void)mapViewWillStartLoadingMap:(BharatMapsMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishLoadingMap:(BharatMapsMapView *)mapView;
 ...
 */
- (void)mapViewDidFailLoadingMap:(BharatMapsMapView *)mapView withError:(NSError *)error;

// TODO
- (void)mapViewWillStartRenderingMap:(BharatMapsMapView *)mapView;

// TODO
- (void)mapViewDidFinishRenderingMap:(BharatMapsMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartRenderingFrame:(BharatMapsMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishRenderingFrame:(BharatMapsMapView *)mapView fullyRendered:(BOOL)fullyRendered;
/**
 Tells the delegate that the map view has just redrawn.
 ...
 */
- (void)mapViewDidFinishRenderingFrame:(BharatMapsMapView *)mapView
...
- (void)mapViewDidFinishRenderingFrame:(BharatMapsMapView *)mapView
                         fullyRendered:(BOOL)fullyRendered
                        renderingStats:(BharatMapsRenderingStats *)renderingStats;
 ...
 */
- (void)mapViewDidBecomeIdle:(BharatMapsMapView *)mapView;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView didFinishLoadingStyle:(BharatMapsStyle *)style;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView sourceDidChange:(BharatMapsSource *)source;

/**
 Tells the delegate that the `mapView` is missing an image. The image should be added synchronously
 with ``BharatMapsStyle/setImage:forName:`` to be rendered on the current zoom level. When loading icons
 ...
 */
- (nullable UIImage *)mapView:(BharatMapsMapView *)mapView didFailToLoadImage:(NSString *)imageName;
...
/**
 ...
 the cached image.
 */
- (BOOL)mapView:(BharatMapsMapView *)mapView shouldRemoveStyleImage:(NSString *)imageName;
...
/**
 ...
 @param mapView The ``BharatMapsMapView`` instance invoking this delegate method.
...
@param mapView The ``BharatMapsMapView`` instance invoking this delegate method.
@param operation The type of tile operation triggered. See ``BharatMapsTileOperation``.
...
*/
- (void)mapView:(BharatMapsMapView *)mapView
    tileDidTriggerAction:(BharatMapsTileOperation)operation
                       x:(NSInteger)x
                       y:(NSInteger)y
                       z:(NSInteger)z
                    wrap:(NSInteger)wrap
...
> Warning: This method is not thread-safe.
*/
- (void)mapView:(BharatMapsMapView *)mapView spriteWillLoad:(NSString *)id url:(NSString *)url;
...
> Warning: This method is not thread-safe.
*/
- (void)mapView:(BharatMapsMapView *)mapView spriteDidLoad:(NSString *)id url:(NSString *)url;
...
> Warning: This method is not thread-safe.
*/
- (void)mapView:(BharatMapsMapView *)mapView spriteDidError:(NSString *)id url:(NSString *)url;
 ...
 */
- (void)mapViewWillStartLocatingUser:(BharatMapsMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (void)mapViewDidStopLocatingUser:(BharatMapsMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (BharatMapsUserLocationAnnotationViewStyle *)mapViewStyleForDefaultUserLocationAnnotationView:
    (BharatMapsMapView *)mapView NS_SWIFT_NAME(mapView(styleForDefaultUserLocationAnnotationView:));
...
/**
 ...
 ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeFollowWithHeading`` and the heading changes, or if it is
 set to ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeFollowWithCourse`` and the course changes.
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView
    didUpdateUserLocation:(nullable BharatMapsUserLocation *)userLocation;
...
/**
 ...
 @param error An error object containing the reason why location tracking
    failed.
 */
- (void)mapView:(BharatMapsMapView *)mapView didFailToLocateUserWithError:(NSError *)error;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView
    didChangeUserTrackingMode:(BharatMapsUserTrackingMode)mode
                     animated:(BOOL)animated;
...
/**
 ...
 This method will override any values set by ``BharatMapsMapView/userLocationVerticalAlignment``
 or ``BharatMapsMapView/setUserLocationVerticalAlignment:animated:``.

 @param mapView The map view that is tracking the user's location.
 */
- (CGPoint)mapViewUserLocationAnchorPoint:(BharatMapsMapView *)mapView;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView
    didChangeLocationManagerAuthorization:(id<BharatMapsLocationManager>)manager API_AVAILABLE(ios(14));
...
/**
 ...
 image should be used for ``BharatMapsAnnotation`` objects that have been added to
 your map
 */
- (nullable BharatMapsAnnotationImage *)mapView:(BharatMapsMapView *)mapView
 ...
 */
- (CGFloat)mapView:(BharatMapsMapView *)mapView alphaForShapeAnnotation:(BharatMapsShape *)annotation;
...
/**
 ...
 ``BharatMapsShape`` object that has been added to your map as an annotation.
 */
- (UIColor *)mapView:(BharatMapsMapView *)mapView strokeColorForShapeAnnotation:(BharatMapsShape *)annotation;
...
/**
 ...
 ``BharatMapsPolygon`` at runtime.
 */
- (UIColor *)mapView:(BharatMapsMapView *)mapView fillColorForPolygonAnnotation:(BharatMapsPolygon *)annotation;
...
/**
 ...
 line width of an ``BharatMapsPolylineFeature`` on your map.
 */
- (CGFloat)mapView:(BharatMapsMapView *)mapView lineWidthForPolylineAnnotation:(BharatMapsPolyline *)annotation;
...
/**
 ...
 `annotation` is an instance of ``BharatMapsUserLocation`` (or equal to the map view’s
 `userLocation` property), return an instance of ``BharatMapsUserLocationAnnotationView``
 ...
 ``BharatMapsAnnotation`` to use for a given ``BharatMapsAnnotation`` object on your
 map.
 */
- (nullable BharatMapsAnnotationView *)mapView:(BharatMapsMapView *)mapView
                      viewForAnnotation:(id<BharatMapsAnnotation>)annotation;
...
/**
 ...
 @param annotationViews An array of ``BharatMapsAnnotationView`` objects representing the
    views that were added.
 */
- (void)mapView:(BharatMapsMapView *)mapView
    didAddAnnotationViews:(NSArray<BharatMapsAnnotationView *> *)annotationViews;
 ...
 */
- (BOOL)mapView:(BharatMapsMapView *)mapView shapeAnnotationIsEnabled:(BharatMapsShape *)annotation;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView didSelectAnnotation:(id<BharatMapsAnnotation>)annotation;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView didDeselectAnnotation:(id<BharatMapsAnnotation>)annotation;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView didSelectAnnotationView:(BharatMapsAnnotationView *)annotationView;
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView didDeselectAnnotationView:(BharatMapsAnnotationView *)annotationView;
...
/**
 ...
 ``BharatMapsAnnotation`` objects.
 */
- (BOOL)mapView:(BharatMapsMapView *)mapView annotationCanShowCallout:(id<BharatMapsAnnotation>)annotation;
...
/**
 ...
 @param annotation The object representing the annotation.
 @return A view conforming to the ``BharatMapsCalloutView`` protocol, or `nil` to use the
    default callout view.

 #### Related examples
 TODO: Display custom views as callouts, learn how to customize an
 ``BharatMapsAnnotation`` object's ``BharatMapsAnnotation``.
 */
- (nullable id<BharatMapsCalloutView>)mapView:(BharatMapsMapView *)mapView
              calloutViewForAnnotation:(id<BharatMapsAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(BharatMapsMapView *)mapView
    leftCalloutAccessoryViewForAnnotation:(id<BharatMapsAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(BharatMapsMapView *)mapView
    rightCalloutAccessoryViewForAnnotation:(id<BharatMapsAnnotation>)annotation;
...
/**
 ...
 custom accessory views using the ``BharatMapsCalloutView`` protocol’s
 ...
 */
- (void)mapView:(BharatMapsMapView *)mapView
                       annotation:(id<BharatMapsAnnotation>)annotation
...
/**
 ...
 ``BharatMapsCalloutViewDelegate/calloutViewTapped:`` method.
 ...
 action when an ``BharatMapsAnnotation``s ``BharatMapsAnnotation`` is tapped.
 */
- (void)mapView:(BharatMapsMapView *)mapView tapOnCalloutForAnnotation:(id<BharatMapsAnnotation>)annotation;

// MARK: BharatMapView interactions

/**
 Called when a POI feature is tapped on ``BharatMapView``.
 */
- (void)bharatMapView:(BharatMapView *)bharatMapView didTapPoi:(BharatMapsPoiResult *)poi;

/**
 Called when a building number feature is tapped on ``BharatMapView``.
 */
- (void)bharatMapView:(BharatMapView *)bharatMapView didTapBuildingNumber:(BharatMapsBuildingNumberResult *)buildingNumber;

/**
 Called when a uPin feature is tapped on ``BharatMapView``.
 */
- (void)bharatMapView:(BharatMapView *)bharatMapView didTapUPin:(BharatMapsUPinResult *)uPin;

/**
 Called when reverse geocoding result is available for long press on ``BharatMapView``.
 */
- (void)bharatMapView:(BharatMapView *)bharatMapView didReceiveReverseGeocoding:(BharatMapsReverseGeocodingResult *)result;

/**
 Called when reverse geocoding fails for long press on ``BharatMapView``.
 */
- (void)bharatMapView:(BharatMapView *)bharatMapView
didFailReverseGeocodingWithError:(NSString *)message
             location:(CLLocationCoordinate2D)location;

/**
 Called when trip progress changes during active navigation on ``BharatMapView``.
 */
- (void)bharatMapView:(BharatMapView *)bharatMapView didUpdateTripProgress:(BharatMapsTripProgress *)progress;
