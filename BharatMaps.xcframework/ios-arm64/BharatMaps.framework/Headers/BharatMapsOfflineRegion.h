...
/**
 An object conforming to the ``BharatMapsOfflineRegion`` protocol determines which
 resources are required by an ``BharatMapsOfflinePack`` object.
 */
@protocol BharatMapsOfflineRegion <NSObject>
...
/**
 ...
 See `BharatMapsIdeographicFontFamilyName` setting. Also, for regions outside of
