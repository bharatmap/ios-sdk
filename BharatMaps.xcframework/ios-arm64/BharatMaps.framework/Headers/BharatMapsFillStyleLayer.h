...
/**
 ...
 ``BharatMapsFillStyleLayer/fillTranslation``.

 Values of this type are used in the ``BharatMapsFillStyleLayer/fillTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, BharatMapsFillTranslationAnchor) {
    /**
     The fill is translated relative to the map.
     */
    BharatMapsFillTranslationAnchorMap,
    /**
     The fill is translated relative to the viewport.
     */
    BharatMapsFillTranslationAnchorViewport,
};

/**
 An ``BharatMapsFillStyleLayer`` is a style layer that renders one or more
 filled (and optionally stroked) polygons on the map.
 ...
 ``BharatMapsFillStyleLayer`` object, or they can be
 ``BharatMapsFillStyleLayer``, ``BharatMapsFillStyleLayer``,
 ``BharatMapsFillStyleLayer``, or ``BharatMapsFillStyleLayer`` instances in an
 ``BharatMapsFillStyleLayer`` or ``BharatMapsFillStyleLayer`` object.
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsFillStyleLayer : BharatMapsVectorStyleLayer
...
*/
@property (nonatomic) BharatMapsTransition fillColorTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillOpacityTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillOutlineColorTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillPatternTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillTranslationTransition;
 ...
 * Constant `BharatMapsFillTranslationAnchor` values
...
/**
 ...
 ``BharatMapsFillStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (BharatMapsFillStyleLayerAdditions)

// MARK: Working with Fill Style Layer Attribute Values

/**
 Creates a new value object containing the given `BharatMapsFillTranslationAnchor` enumeration.

 @param fillTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithBharatMapsFillTranslationAnchor:(BharatMapsFillTranslationAnchor)fillTranslationAnchor;

/**
 The ``BharatMapsFillTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) BharatMapsFillTranslationAnchor BharatMapsFillTranslationAnchorValue;
