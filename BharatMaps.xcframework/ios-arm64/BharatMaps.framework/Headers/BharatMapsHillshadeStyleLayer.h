...
/**
 ...
 Values of this type are used in the ``BharatMapsHillshadeStyleLayer/hillshadeIlluminationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, BharatMapsHillshadeIlluminationAnchor) {
    /**
     The hillshade illumination is relative to the north direction.
     */
    BharatMapsHillshadeIlluminationAnchorMap,
    /**
     The hillshade illumination is relative to the top of the viewport.
     */
    BharatMapsHillshadeIlluminationAnchorViewport,
};

/**
 An ``BharatMapsHillshadeStyleLayer`` is a style layer that renders raster <a
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsHillshadeStyleLayer : BharatMapsForegroundStyleLayer
...
*/
@property (nonatomic) BharatMapsTransition hillshadeAccentColorTransition;
...
*/
@property (nonatomic) BharatMapsTransition hillshadeExaggerationTransition;
...
*/
@property (nonatomic) BharatMapsTransition hillshadeHighlightColorTransition;
 ...
 * Constant `BharatMapsHillshadeIlluminationAnchor` values
...
/**
 ...
 `BharatMapsHillshadeIlluminationAnchorViewport` and due north if
 `hillshadeIlluminationAnchor` is set to
 `BharatMapsHillshadeIlluminationAnchorMap`.
...
*/
@property (nonatomic) BharatMapsTransition hillshadeShadowColorTransition;

@end

/**
 Methods for wrapping an enumeration value for a style layer attribute in an
 ``BharatMapsHillshadeStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (BharatMapsHillshadeStyleLayerAdditions)

// MARK: Working with Hillshade Style Layer Attribute Values

/**
 Creates a new value object containing the given `BharatMapsHillshadeIlluminationAnchor` enumeration.

 @param hillshadeIlluminationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithBharatMapsHillshadeIlluminationAnchor:(BharatMapsHillshadeIlluminationAnchor)hillshadeIlluminationAnchor;

/**
 The ``BharatMapsHillshadeIlluminationAnchor`` enumeration representation of the value.
 */
@property (readonly) BharatMapsHillshadeIlluminationAnchor BharatMapsHillshadeIlluminationAnchorValue;
