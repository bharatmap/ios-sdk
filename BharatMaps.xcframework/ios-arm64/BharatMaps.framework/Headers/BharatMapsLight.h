 ...
 */
typedef NS_ENUM(NSUInteger, BharatMapsLightAnchor) {
    /**
     The position of the light source is aligned to the rotation of the map.
     */
    BharatMapsLightAnchorMap,
    /**
     The position of the light source is aligned to the rotation of the
     viewport.
     */
    BharatMapsLightAnchorViewport,
};
 ...
 */
typedef struct __attribute__((objc_boxable)) BharatMapsSphericalPosition {
    /** Distance from the center of the base of an object to its light. */
    CGFloat radial;
    /** Position of the light relative to 0° (0° when ``BharatMapsLight/anchor`` is set to viewport corresponds
     to the top of the viewport, or 0° when ``BharatMapsLight/anchor`` is set to map corresponds to due north,
...
} BharatMapsSphericalPosition;

/**
 Creates a new ``BharatMapsSphericalPosition`` from the given radial, azimuthal, polar.

 @param radial The radial coordinate.
 @param azimuthal The azimuthal angle.
 @param polar The polar angle.

 @return Returns a ``BharatMapsSphericalPosition`` struct containing the position attributes.
 */
NS_INLINE BharatMapsSphericalPosition BharatMapsSphericalPositionMake(CGFloat radial, CLLocationDirection azimuthal, CLLocationDirection polar) {
    BharatMapsSphericalPosition position;
...
/**
  An ``BharatMapsLight`` object represents the light source for extruded
 geometries in ``BharatMapsLight``.
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsLight : NSObject
 ...
 * Constant `BharatMapsAnchor` values
...
/**
 Position of the ``BharatMapsLight`` source relative to lit (extruded)
 geometries, in a ``BharatMapsLight`` struct [radial coordinate, azimuthal
 angle, polar angle] where radial indicates the distance from the center of the
 base of an object to its light, azimuthal indicates the position of the light
 relative to 0° (0° when ``BharatMapsLight/anchor`` is set to
 ``BharatMapsLight`` corresponds to the top of the viewport, or 0° when
 ``BharatMapsLight/anchor`` is set to ``BharatMapsLight`` corresponds to due
 north, and degrees proceed clockwise), and polar indicates the height of the
 light (from 0°, directly above, to 180°, directly below).
 
 The default value of this property is an expression that evaluates to an
 ``BharatMapsSphericalPosition`` struct set to 1.15 radial, 210 azimuthal and 30
 polar.
 
 You can set this property to an expression containing any of the following:
 
 * Constant ``BharatMapsSphericalPosition`` values
 * Predefined functions, including mathematical and string operators
 * Conditional expressions
 * Variable assignments and references to assigned variables
...
*/
@property (nonatomic) BharatMapsTransition positionTransition;
...
*/
@property (nonatomic) BharatMapsTransition colorTransition;
...
*/
@property (nonatomic) BharatMapsTransition intensityTransition;
