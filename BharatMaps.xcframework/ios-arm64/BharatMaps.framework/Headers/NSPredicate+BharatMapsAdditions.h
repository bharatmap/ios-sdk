...
@interface NSPredicate (BharatMapsAdditions)
...
/**
 ...
 with the ``BharatMapsVectorStyleLayer/predicate`` property.
 */
+ (instancetype)predicateWithBharatMapsJSONObject:(id)object NS_SWIFT_NAME(init(mglJSONObject:));
