...
/**
 The ``BharatMapsAnnotation`` protocol is used to provide annotation-related information
 ...
 ``BharatMapsAnnotation`` protocol
 */
@protocol BharatMapsAnnotation <NSObject>
