...
/**
 ...
 ``BharatMapsFillExtrusionStyleLayer/fillExtrusionTranslation``.

 Values of this type are used in the ``BharatMapsFillExtrusionStyleLayer/fillExtrusionTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, BharatMapsFillExtrusionTranslationAnchor) {
    /**
     The fill extrusion is translated relative to the map.
     */
    BharatMapsFillExtrusionTranslationAnchorMap,
    /**
     The fill extrusion is translated relative to the viewport.
     */
    BharatMapsFillExtrusionTranslationAnchorViewport,
};

/**
 An ``BharatMapsFillExtrusionStyleLayer`` is a style layer that renders one or
 more 3D extruded polygons on the map.
 ...
 an ``BharatMapsFillExtrusionStyleLayer`` object, or they can be
 ``BharatMapsFillExtrusionStyleLayer``, ``BharatMapsFillExtrusionStyleLayer``,
 ``BharatMapsFillExtrusionStyleLayer``, or ``BharatMapsFillExtrusionStyleLayer``
 instances in an ``BharatMapsFillExtrusionStyleLayer`` or
 ``BharatMapsFillExtrusionStyleLayer`` object.
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsFillExtrusionStyleLayer : BharatMapsVectorStyleLayer
...
*/
@property (nonatomic) BharatMapsTransition fillExtrusionBaseTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillExtrusionColorTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillExtrusionHeightTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillExtrusionOpacityTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillExtrusionPatternTransition;
...
*/
@property (nonatomic) BharatMapsTransition fillExtrusionTranslationTransition;
 ...
 * Constant `BharatMapsFillExtrusionTranslationAnchor` values
...
/**
 ...
 ``BharatMapsFillExtrusionStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (BharatMapsFillExtrusionStyleLayerAdditions)

// MARK: Working with Fill extrusion Style Layer Attribute Values

/**
 Creates a new value object containing the given `BharatMapsFillExtrusionTranslationAnchor` enumeration.

 @param fillExtrusionTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithBharatMapsFillExtrusionTranslationAnchor:(BharatMapsFillExtrusionTranslationAnchor)fillExtrusionTranslationAnchor;

/**
 The ``BharatMapsFillExtrusionTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) BharatMapsFillExtrusionTranslationAnchor BharatMapsFillExtrusionTranslationAnchorValue;
