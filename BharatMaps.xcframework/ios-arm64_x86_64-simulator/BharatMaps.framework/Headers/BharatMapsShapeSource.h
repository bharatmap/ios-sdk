...
@class BharatMapsPointFeature;
@class BharatMapsPointFeatureCluster;
@class BharatMapsShape;

/**
 Options for ``BharatMapsShapeSource`` objects.
 */
typedef NSString *BharatMapsShapeSourceOption NS_STRING_ENUM;
...
/**
 ...
 Learn how to cluster point data with this ``BharatMapsShapeSourceOption``.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsShapeSourceOption BharatMapsShapeSourceOptionClustered;
...
/**
 ...
 is ignored when creating an ``BharatMapsComputedShapeSource`` object.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsShapeSourceOption BharatMapsShapeSourceOptionClusterRadius;
...
/**
 ...
 is ignored when creating an ``BharatMapsComputedShapeSource`` object.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsShapeSourceOption BharatMapsShapeSourceOptionClusterMinPoints;
...
/**
 ...
 let options : [BharatMapsShapeSourceOption : Any] = [.clustered : true,
 ...
 is ignored when creating an ``BharatMapsComputedShapeSource`` object.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsShapeSourceOption BharatMapsShapeSourceOptionClusterProperties;
/**
 An `NSNumber` object containing an integer; specifies the maximum zoom level at
 which to cluster points if clustering is enabled. Defaults to one zoom level
 less than the value of ``BharatMapsShapeSourceOptionMaximumZoomLevel`` so that, at the
 ...
 is ignored when creating an ``BharatMapsComputedShapeSource`` object.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsShapeSourceOption
    BharatMapsShapeSourceOptionMaximumZoomLevelForClustering;
...
/**
 ...
 Set this property to `YES` in order for the ``BharatMapsLineStyleLayer/lineGradient`` property to have its
 ...
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsShapeSourceOption BharatMapsShapeSourceOptionSynchronousUpdate;

/**
 ``BharatMapsShapeSource`` is a map content source that supplies vector shapes to be
 shown on the map. The shapes may be instances of ``BharatMapsShape`` or ``BharatMapsShape``,
 ...
 ``BharatMapsShapeSource`` is optimized for data sets that change dynamically and fit
 ...
 using methods such as ``BharatMapsStyle/addSource:`` and
 ``BharatMapsStyle/sourceWithIdentifier:``.
 ...
 let polyline = BharatMapsPolylineFeature(coordinates: &coordinates, count: UInt(coordinates.count))
 let source = BharatMapsShapeSource(identifier: "lines", features: [polyline], options: nil)
 ...
 TODO: Use images to cluster point data
 TODO: Add live data
 Learn how to add data to your map using this ``BharatMapsSource`` object.
 */
BharatMaps_EXPORT
@interface BharatMapsShapeSource : BharatMapsSource
...
/**
 ...
 This class supports the following options: ``BharatMapsShapeSourceOptionClustered``,
 ``BharatMapsShapeSourceOptionClusterRadius``,
 ``BharatMapsShapeSourceOptionMaximumZoomLevelForClustering``,
 ``BharatMapsShapeSourceOptionMinimumZoomLevel``, ``BharatMapsShapeSourceOptionMinimumZoomLevel``,
 ``BharatMapsShapeSourceOptionBuffer``, and
 ``BharatMapsShapeSourceOptionSimplificationTolerance``. Shapes provided by a shape
 ...
 updating the an ``BharatMapsShapeSource`` object's `URL` property.
 */
...
/**
 ...
 This class supports the following options: ``BharatMapsShapeSourceOptionClustered``,
 ``BharatMapsShapeSourceOptionClusterRadius``, ``BharatMapsShapeSourceOptionClusterMinPoints``,
 ``BharatMapsShapeSourceOptionMaximumZoomLevelForClustering``,
 ``BharatMapsShapeSourceOptionMinimumZoomLevel``, ``BharatMapsShapeSourceOptionMinimumZoomLevel``,
 ``BharatMapsShapeSourceOptionBuffer``, and
 ``BharatMapsShapeSourceOptionSimplificationTolerance``. Shapes provided by a shape
 ...
 To specify attributes about the shape, use an instance of an ``BharatMapsShape``
 subclass that conforms to the ``BharatMapsFeature`` protocol, such as ``BharatMapsFeature``.
 To include multiple shapes in the source, use an ``BharatMapsShapeCollection`` or
 ``BharatMapsShapeCollectionFeature`` object, or use the
 ...
 ``BharatMapsShape/shapeWithData:encoding:error:`` method.

 @param identifier A string that uniquely identifies the source.
 @param shape A concrete subclass of ``BharatMapsShape``
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.

 #### Related examples
 TODO: Animate a line, learn how to animate line data by continously
 updating an ``BharatMapsShapeSource``'s `shape` attribute.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier
                             shape:(nullable BharatMapsShape *)shape
                           options:(nullable NSDictionary<BharatMapsShapeSourceOption, id> *)options
    NS_DESIGNATED_INITIALIZER;
...
/**
 ...
 Unlike `-initWithIdentifier:shapes:options:`, this method accepts ``BharatMapsFeature``
 instances, such as ``BharatMapsPointFeature`` objects, whose attributes you can use when
 applying a predicate to ``BharatMapsVectorStyleLayer`` or configuring a style layer’s
 appearance.
 ...
 @param identifier A string that uniquely identifies the source.
 @param features An array of objects that conform to the BharatMapsFeature protocol.
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier
                          features:(NSArray<BharatMapsShape<BharatMapsFeature> *> *)features
                           options:(nullable NSDictionary<BharatMapsShapeSourceOption, id> *)options;
...
/**
 ...
 Any ``BharatMapsFeature`` instance passed into this initializer is treated as an ordinary
 shape, causing any attributes to be inaccessible to an ``BharatMapsVectorStyleLayer`` when
 ...
 @param identifier A string that uniquely identifies the source.
 @param shapes An array of shapes; each shape is a member of a concrete subclass of BharatMapsShape.
 @param options An `NSDictionary` of options for this source.
 @return An initialized shape source.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier
                            shapes:(NSArray<BharatMapsShape *> *)shapes
                           options:(nullable NSDictionary<BharatMapsShapeSourceOption, id> *)options;
...
/**
 ...
 passed into ``BharatMapsStyle/addSource:``.
 ...
 */
@property (nonatomic, copy, nullable) BharatMapsShape *shape;
 ...
 */
- (NSArray<id<BharatMapsFeature>> *)featuresMatchingPredicate:(nullable NSPredicate *)predicate;
...
/**
 ...
 @param cluster An object of type ``BharatMapsPointFeatureCluster`` (that conforms to the
 ``BharatMapsPointFeatureCluster`` protocol).
 @param offset Number of features to skip.
 @param limit The maximum number of features to return

 @return An array of objects that conform to the ``BharatMapsFeature`` protocol.
 */
- (NSArray<id<BharatMapsFeature>> *)leavesOfCluster:(BharatMapsPointFeatureCluster *)cluster
...
/**
 ...
 the ``BharatMapsCluster`` protocol (currently only objects of type ``BharatMapsCluster``).
 ...
 > Note: The returned array may contain the `cluster` that was passed in, if the next
    ...
    ``BharatMapsShapeSource/zoomLevelForExpandingCluster:``.
 */
- (NSArray<id<BharatMapsFeature>> *)childrenOfCluster:(BharatMapsPointFeatureCluster *)cluster;
...
/**
 ...
 @return Zoom level. This should be >= 0; any negative return value should be
    considered an error.
 */
- (double)zoomLevelForExpandingCluster:(BharatMapsPointFeatureCluster *)cluster;
