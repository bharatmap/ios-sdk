...
#import "BharatMapsBackendResource.h"
#import "BharatMapsCompassButton.h"
#import "BharatMapsFoundation.h"
#import "BharatMapsGeometry.h"
#import "BharatMapsMapCamera.h"
#import "BharatMapsMapOptions.h"
#import "BharatMapsStyle.h"
#import "BharatMapsTypes.h"

NS_ASSUME_NONNULL_BEGIN

@class BharatMapsAnnotationView;
@class BharatMapsAnnotationImage;
@class BharatMapsUserLocation;
@class BharatMapsMapProjection;
@class BharatMapsPolyline;
@class BharatMapsPolygon;
@class BharatMapsScaleBar;
@class BharatMapsShape;
@class BharatMapsPluginLayer;

@protocol BharatMapsMapViewDelegate;
@protocol BharatMapsAnnotation;
@protocol BharatMapsOverlay;
@protocol BharatMapsCalloutView;
@protocol BharatMapsFeature;
@protocol BharatMapsLocationManager;

/** Options for ``BharatMapsMapView/decelerationRate``. */
typedef CGFloat BharatMapsMapViewDecelerationRate NS_TYPED_EXTENSIBLE_ENUM;

/** The default deceleration rate for a map view. */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsMapViewDecelerationRate BharatMapsMapViewDecelerationRateNormal;

/** A fast deceleration rate for a map view. */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsMapViewDecelerationRate BharatMapsMapViewDecelerationRateFast;

/** Disables deceleration in a map view. */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsMapViewDecelerationRate BharatMapsMapViewDecelerationRateImmediate;

/**
 The vertical alignment of an annotation within a map view. Used with
 ``BharatMapsMapView/userLocationVerticalAlignment``.
 */
typedef NS_ENUM(NSUInteger, BharatMapsAnnotationVerticalAlignment) {
  /** Aligns the annotation vertically in the center of the map view. */
  BharatMapsAnnotationVerticalAlignmentCenter = 0,
  /** Aligns the annotation vertically at the top of the map view. */
  BharatMapsAnnotationVerticalAlignmentTop,
  /** Aligns the annotation vertically at the bottom of the map view. */
  BharatMapsAnnotationVerticalAlignmentBottom,
};

/**
 The position of scale bar, compass, logo and attribution in a map view. Used with
 ``BharatMapsMapView/scaleBarPosition``,
 ``BharatMapsMapView/compassViewPosition``,
 ``BharatMapsMapView/logoViewPosition``,
 ``BharatMapsMapView/attributionButtonPosition``.
 */
typedef NS_ENUM(NSUInteger, BharatMapsOrnamentPosition) {
  /** Place the ornament in the top left of the map view. */
  BharatMapsOrnamentPositionTopLeft = 0,
  /** Place the ornament in the top right of the map view. */
  BharatMapsOrnamentPositionTopRight,
  /** Place the ornament in the bottom left of the map view. */
  BharatMapsOrnamentPositionBottomLeft,
  /** Place the ornament in the bottom right of the map view. */
  BharatMapsOrnamentPositionBottomRight,
};

/**
 The mode used to track the user location on the map. Used with
 ``BharatMapsMapView/userTrackingMode``.

 #### Related examples
 - TODO: Switch between user tracking modes</a> example to learn how to toggle modes and
 how each mode behaves.
 */
typedef NS_ENUM(NSUInteger, BharatMapsUserTrackingMode) {
  /** The map does not follow the user location. */
  BharatMapsUserTrackingModeNone = 0,
  /** The map follows the user location. This tracking mode falls back
      to ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeNone`` if the user pans the map view. */
  BharatMapsUserTrackingModeFollow,
  /**
      ...
      view, this tracking mode will fall back to ``BharatMapsUserTrackingModeFollow``.
   */
  BharatMapsUserTrackingModeFollowWithHeading,
  /**
      ...
      this tracking mode will fall back to ``BharatMapsUserTrackingModeFollow``.
   */
  BharatMapsUserTrackingModeFollowWithCourse,
};

typedef NS_ENUM(NSUInteger, BharatMapsPanScrollingMode) {
  /** The map allows the user to only scroll horizontally. */
  BharatMapsPanScrollingModeHorizontal = 0,
  /** The map allows the user to only scroll vertically. */
  BharatMapsPanScrollingModeVertical,
  /** The map allows the user to scroll both horizontally and vertically. */
  BharatMapsPanScrollingModeDefault
};

/** Options for ``BharatMapsMapView/preferredFramesPerSecond``. */
typedef NSInteger BharatMapsMapViewPreferredFramesPerSecond NS_TYPED_EXTENSIBLE_ENUM;

/**
 The default frame rate. This can be either 30 FPS or 60 FPS, depending on
 device capabilities.
 */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsMapViewPreferredFramesPerSecond
    BharatMapsMapViewPreferredFramesPerSecondDefault;

/** A conservative frame rate; typically 30 FPS. */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsMapViewPreferredFramesPerSecond
    BharatMapsMapViewPreferredFramesPerSecondLowPower;

/** The maximum supported frame rate; typically 60 FPS. */
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsMapViewPreferredFramesPerSecond
    BharatMapsMapViewPreferredFramesPerSecondMaximum;

FOUNDATION_EXTERN BharatMaps_EXPORT
    BharatMapsExceptionName const BharatMapsMissingLocationServicesUsageDescriptionException;
FOUNDATION_EXTERN BharatMaps_EXPORT BharatMapsExceptionName const BharatMapsUserLocationAnnotationTypeException;

/**
 An interactive, customizable map view with an interface similar to the one
 provided by Apple’s MapKit.

 Using ``BharatMapsMapView``, you can embed the map inside a view, allow users to
 ...
 in the ``BharatMapsMapViewDelegate`` protocol documentation.

 Adding your own gesture recognizer to ``BharatMapsMapView`` will block the corresponding
 gesture recognizer built into ``BharatMapsMapView``. To avoid conflicts, define which
 gesture takes precedence. For example, you can create your own
 `UITapGestureRecognizer` that will be invoked only if the default ``BharatMapsMapView``
 tap gesture fails:
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsMapView : UIView <BharatMapsStylable>
...
/**
 ...
 @return An initialized map view.
 */
- (instancetype)initWithFrame:(CGRect)frame options:(BharatMapsMapOptions *)options;
...
/**
 ...
 annotations.
 */
@property (nonatomic, weak, nullable) IBOutlet id<BharatMapsMapViewDelegate> delegate;
...
/**
 ...
 ``BharatMapsMapViewDelegate/mapView:didFinishLoadingStyle:`` or
 ``BharatMapsMapViewDelegate/mapViewDidFinishLoadingMap:`` method. It is not possible
 ...
 */
@property (nonatomic, readonly) BharatMapsScaleBar *scaleBar;
...
/**
 ...
 ``BharatMapsOrnamentPosition/BharatMapsOrnamentPositionTopLeft``.
 */
@property (nonatomic, assign) BharatMapsOrnamentPosition scaleBarPosition;
 ...
 */
@property (nonatomic, readonly) BharatMapsCompassButton *compassView;

/**
 The position of the compass view. The default value is
 ``BharatMapsOrnamentPosition/BharatMapsOrnamentPositionTopRight``.
 */
@property (nonatomic, assign) BharatMapsOrnamentPosition compassViewPosition;
...
/**
 ...
 ``BharatMapsOrnamentPosition/BharatMapsOrnamentPositionBottomLeft``.
 */
@property (nonatomic, assign) BharatMapsOrnamentPosition logoViewPosition;
...
/**
 ...
 ``BharatMapsOrnamentPosition/BharatMapsOrnamentPositionBottomRight``.
 */
@property (nonatomic, assign) BharatMapsOrnamentPosition attributionButtonPosition;
...
/**
 ...
 ``BharatMapsMapViewPreferredFramesPerSecondDefault``, which will adaptively set the
 preferred frame rate based on the capability of the user’s device to maintain
 a smooth experience.

 In addition to the provided ``BharatMapsMapViewPreferredFramesPerSecond`` options, this
 property can be set to arbitrary integer values.

 @see `CADisplayLink.preferredFramesPerSecond`
 */
@property (nonatomic, assign) BharatMapsMapViewPreferredFramesPerSecond preferredFramesPerSecond;
...
/**
 ...
 ``BharatMapsMapViewDelegate/mapView:didUpdateUserLocation:`` and
 ``BharatMapsMapViewDelegate/mapView:didFailToLocateUserWithError:`` methods.

 If setting this property to `nil` or if no custom manager is provided this
 property is set to the default location manager.

 ``BharatMapsMapView`` uses a default location manager. If you want to substitute your
 ...
 */
@property (nonatomic, null_resettable) id<BharatMapsLocationManager> locationManager;
 ...
 */
@property (nonatomic, readonly, nullable) BharatMapsUserLocation *userLocation;

/**
 The mode used to track the user location. The default value is
 ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeNone``.
 ...
 default user location annotation shown by ``BharatMapsUserTrackingMode``.
 */
@property (nonatomic, assign) BharatMapsUserTrackingMode userTrackingMode;
 ...
 */
- (void)setUserTrackingMode:(BharatMapsUserTrackingMode)mode
...
/**
 ...
 default value is ``BharatMapsAnnotationVerticalAlignment/BharatMapsAnnotationVerticalAlignmentCenter``.

 Changing the value of this property updates the map view with an animated
 transition. If you don’t want to animate the change, use the
 `-setUserLocationVerticalAlignment:animated:` method instead.
 */
@property (nonatomic, assign) BharatMapsAnnotationVerticalAlignment userLocationVerticalAlignment
    __attribute__((
        deprecated("Use ``BharatMapsMapViewDelegate/mapViewUserLocationAnchorPoint:`` instead.")));
 ...
 */
- (void)setUserLocationVerticalAlignment:(BharatMapsAnnotationVerticalAlignment)alignment
                                animated:(BOOL)animated
    __attribute__((
        deprecated("Use ``BharatMapsMapViewDelegate/mapViewUserLocationAnchorPoint:`` instead.")));
...
/**
 ...
 ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeFollowWithHeading``.

 This property has no effect when ``userTrackingMode`` is
 ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeFollowWithHeading`` or
 ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeFollowWithCourse``.
...
/**
 ...
 value other than ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeFollowWithCourse``.
...
/**
 ...
 other than ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeFollowWithCourse``.
...
`BharatMapsPanScrollingModeHorizontal` only allows the user to scroll horizontally on the map,
 restricting a user's ability to scroll vertically.
`BharatMapsPanScrollingModeVertical` only allows the user to scroll vertically on the map,
 restricting a user's ability to scroll horizontally.
 ``BharatMapsPanScrollingMode/BharatMapsPanScrollingModeDefault`` allows the user to scroll both horizontally and
vertically on the map.

 By default, this property is set to ``BharatMapsPanScrollingMode/BharatMapsPanScrollingModeDefault``.
 */
@property (nonatomic, assign) BharatMapsPanScrollingMode panScrollingMode;
...
/**
 ...
 Your application can use the ``BharatMapsMapViewDecelerationRateNormal`` and
 ``BharatMapsMapViewDecelerationRateFast`` constants as reference points for reasonable
 deceleration rates. ``BharatMapsMapViewDecelerationRateImmediate`` can be used to
 ...
 */
@property (nonatomic) BharatMapsCoordinateBounds maximumScreenBounds;
 ...
 */
@property (nonatomic) BharatMapsCoordinateBounds visibleCoordinateBounds;
 ...
 */
- (void)setVisibleCoordinateBounds:(BharatMapsCoordinateBounds)bounds animated:(BOOL)animated;
 ...
 */
- (void)setVisibleCoordinateBounds:(BharatMapsCoordinateBounds)bounds
 ...
 */
- (void)showAnnotations:(NSArray<id<BharatMapsAnnotation>> *)annotations animated:(BOOL)animated;
...
/**
 ...
 @param animated `YES` if you want the map region change to be animated, or `NO`
    if you want the map to display the new region immediately without animations.
 */
- (void)showAnnotations:(NSArray<id<BharatMapsAnnotation>> *)annotations
            edgePadding:(UIEdgeInsets)insets
               animated:(BOOL)animated
    __attribute__((
 ...
 */
@property (nonatomic, copy) BharatMapsMapCamera *camera;
 ...
 */
- (void)setCamera:(BharatMapsMapCamera *)camera animated:(BOOL)animated;
 ...
 */
- (void)setCamera:(BharatMapsMapCamera *)camera
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(BharatMapsMapCamera *)camera completionHandler:(nullable void (^)(void))completion;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(BharatMapsMapCamera *)camera
         withDuration:(NSTimeInterval)duration
    completionHandler:(nullable void (^)(void))completion;
 ...
 */
- (BharatMapsMapCamera *)cameraThatFitsCoordinateBounds:(BharatMapsCoordinateBounds)bounds;
...
/**
 ...
 depending on the order of notification delivery.
 */
- (BharatMapsMapCamera *)camera:(BharatMapsMapCamera *)camera
    fittingCoordinateBounds:(BharatMapsCoordinateBounds)bounds
                edgePadding:(UIEdgeInsets)insets;
 ...
 */
- (BharatMapsMapCamera *)camera:(BharatMapsMapCamera *)camera
            fittingShape:(BharatMapsShape *)shape
             edgePadding:(UIEdgeInsets)insets;
...
/**
 ...
 depending on the order of notification delivery.
 */
- (BharatMapsMapCamera *)cameraThatFitsShape:(BharatMapsShape *)shape
                            direction:(CLLocationDirection)direction
                          edgePadding:(UIEdgeInsets)insets;
...
/**
 ...
 If the ``userTrackingMode`` property is not ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeNone``, the
...
/**
 ...
 use the map view’s property ``BharatMapsMapView/automaticallyAdjustsContentInset``instead.
 ...
 */
- (BharatMapsCoordinateBounds)convertRect:(CGRect)rect toCoordinateBoundsFromView:(nullable UIView *)view;
...
/**
 ...
 @param view The view in whose coordinate system the returned rectangle should
    ...
    belong to the same window as the map view.
 */
- (CGRect)convertCoordinateBounds:(BharatMapsCoordinateBounds)bounds toRectToView:(nullable UIView *)view;
 ...
 */
- (BharatMapsMapProjection *)mapProjection;
...
/**
 ...
 The objects in this array must adopt the ``BharatMapsAnnotation`` protocol. If no
 annotations are associated with the map view, the value of this property is
 `nil`.
 */
@property (nonatomic, readonly, nullable) NSArray<id<BharatMapsAnnotation>> *annotations;

/**
 Adds an annotation to the map view.

 > Note: ``BharatMapsMultiPolyline``, ``BharatMapsMultiPolyline``, ``BharatMapsMultiPolyline``, and
    ``BharatMapsPointCollection`` objects cannot be added to the map view at this time.
 ...
 @param annotation The annotation object to add to the receiver. This object
    must conform to the ``BharatMapsAnnotation`` protocol. The map view retains the
    annotation object.

 #### Related examples
 - TODO: add a line annotation from GeoJSON.
 - TODO: add an annotation to an ``BharatMapsMapView`` object.
 */
...
/**
 ...
 > Note: ``BharatMapsMultiPolyline``, ``BharatMapsMultiPolyline``, and ``BharatMapsMultiPolyline`` objects
    cannot be added to the map view at this time. Nor can ``BharatMapsMultiPoint``
 ...
 @param annotations An array of annotation objects. Each object in the array
    must conform to the ``BharatMapsAnnotation`` protocol. The map view retains each
...
/**
 ...
 @param annotation The annotation object to remove. This object must conform
    to the ``BharatMapsAnnotation`` protocol
 */
- (void)removeAnnotation:(id<BharatMapsAnnotation>)annotation;
...
/**
 ...
 @param annotations The array of annotation objects to remove. Objects in the
    array must conform to the ``BharatMapsAnnotation`` protocol.
 */
- (void)removeAnnotations:(NSArray<id<BharatMapsAnnotation>> *)annotations;

/**
 Returns an ``BharatMapsAnnotationView`` if the given annotation is currently associated
 with a view, otherwise nil.

 @param annotation The annotation associated with the view.
    Annotation must conform to the ``BharatMapsAnnotation`` protocol.
 */
- (nullable BharatMapsAnnotationView *)viewForAnnotation:(id<BharatMapsAnnotation>)annotation;

/**
 Returns a reusable annotation image object associated with its identifier.

 For performance reasons, you should generally reuse ``BharatMapsAnnotationImage``
 ...
 reuse an ``BharatMapsAnnotationImage``.
 */
- (nullable __kindof BharatMapsAnnotationImage *)dequeueReusableAnnotationImageWithIdentifier:
    (NSString *)identifier;

/**
 Returns a reusable annotation view object associated with its identifier.

 For performance reasons, you should generally reuse ``BharatMapsAnnotationView``
 objects for identical-looking annotations in your map views. Dequeueing
 saves time and memory during performance-critical operations such as
 scrolling.
 ...
 @return An annotation view object with the given identifier, or `nil` if no
    such object exists in the reuse queue.
 */
- (nullable __kindof BharatMapsAnnotationView *)dequeueReusableAnnotationViewWithIdentifier:
    (NSString *)identifier;
 ...
 */
@property (nonatomic, readonly, nullable) NSArray<id<BharatMapsAnnotation>> *visibleAnnotations;
...
/**
 ...
 @return An array of objects that adopt the ``BharatMapsAnnotation`` protocol or `nil` if
    no annotations associated with the map view are currently visible in the
    rectangle.
 */
- (nullable NSArray<id<BharatMapsAnnotation>> *)visibleAnnotationsInRect:(CGRect)rect;
...
/**
 ...
 If the annotation is of type ``BharatMapsPointAnnotation`` and is offscreen, the camera
 ...
 selected.
 */
@property (nonatomic, copy) NSArray<id<BharatMapsAnnotation>> *selectedAnnotations;
...
/**
 ...
 annotation is not visible (or is partially visible) *and* is of type ``BharatMapsPointAnnotation``, the
 ...
 change the camera.
 */
- (void)selectAnnotation:(id<BharatMapsAnnotation>)annotation
                animated:(BOOL)animated
...
/**
 ...
 ``BharatMapsPointAnnotation``, the map is panned so that the annotation and its callout are brought into
 ...
 */
- (void)deselectAnnotation:(nullable id<BharatMapsAnnotation>)annotation animated:(BOOL)animated;
...
/**
 ...
 The objects in this array must adopt the ``BharatMapsOverlay`` protocol. If no
 overlays are associated with the map view, the value of this property is
 empty array.
 */
@property (nonatomic, readonly, nonnull) NSArray<id<BharatMapsOverlay>> *overlays;
...
/**
 ...
 @param overlay The overlay object to add. This object must conform to the
    ``BharatMapsOverlay`` protocol. */
- (void)addOverlay:(id<BharatMapsOverlay>)overlay;
...
/**
 ...
 @param overlays An array of objects, each of which must conform to the
    ``BharatMapsOverlay`` protocol.
 */
- (void)addOverlays:(NSArray<id<BharatMapsOverlay>> *)overlays;
 ...
 */
- (void)removeOverlay:(id<BharatMapsOverlay>)overlay;
...
/**
 ...
 @param overlays An array of objects, each of which conforms to the ``BharatMapsOverlay``
    protocol.
 */
- (void)removeOverlays:(NSArray<id<BharatMapsOverlay>> *)overlays;
...
/**
 ...
 ``BharatMapsMapView`` object for visible ``BharatMapsMapView`` objects.
 */
- (NSArray<id<BharatMapsFeature>> *)visibleFeaturesAtPoint:(CGPoint)point
...
/**
 ...
 ``BharatMapsShapeSource`` and ``BharatMapsShapeSource`` objects but does not include
 anything from ``BharatMapsRasterTileSource`` objects, or from video or canvas sources,
 ...
 ``BharatMapsFeature`` object representing that bus stop is returned and its
 ...
 visibility, use the
 ``BharatMapsVectorTileSource/featuresInSourceLayersWithIdentifiers:predicate:`` and
 ``BharatMapsShapeSource/featuresMatchingPredicate:`` methods on the relevant sources.

 The returned features may also include features corresponding to annotations.
 These features are not object-equal to the ``BharatMapsAnnotation`` objects that were
 originally added to the map. To query the map for annotations, use
 `visibleAnnotations` or ``BharatMapsMapView/visibleAnnotationsInRect:``.
...
/**
 ...
 @return An array of objects conforming to the ``BharatMapsFeature`` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id<BharatMapsFeature>> *)visibleFeaturesInRect:(CGRect)rect NS_SWIFT_NAME(visibleFeatures(in:));
...
/**
 ...
 @return An array of objects conforming to the ``BharatMapsFeature`` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id<BharatMapsFeature>> *)visibleFeaturesInRect:(CGRect)rect
                      inStyleLayersWithIdentifiers:
                          (nullable NSSet<NSString *> *)styleLayerIdentifiers
...
/**
 ...
 array. On the other hand, if the style does include bus stops, an ``BharatMapsFeature``
 ...
 */
@property (nonatomic) BharatMapsMapDebugMaskOptions debugMask;
...
/**
 Enable a rendering statistics overlay with ``BharatMapsRenderingStats`` values.
 */
...
- (BharatMapsBackendResource *)backendResource;
