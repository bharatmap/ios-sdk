...
/**
 ...
 Values of this type are used in the ``BharatMapsLineStyleLayer/lineCap``
 property.
 */
typedef NS_ENUM(NSUInteger, BharatMapsLineCap) {
    /**
     A cap with a squared-off end which is drawn to the exact endpoint of the
     line.
     */
    BharatMapsLineCapButt,
    /**
     ...
     the line.
     */
    BharatMapsLineCapRound,
    /**
     A cap with a squared-off end which is drawn beyond the endpoint of the line
     at a distance of one-half of the line's width.
     */
    BharatMapsLineCapSquare,
};

/**
 The display of lines when joining.

 Values of this type are used in the ``BharatMapsLineStyleLayer/lineJoin``
 property.
 */
typedef NS_ENUM(NSUInteger, BharatMapsLineJoin) {
    /**
     ...
     */
    BharatMapsLineJoinBevel,
    /**
     A join with a rounded end which is drawn beyond the endpoint of the line at
     a radius of one-half of the line's width and centered on the endpoint of
     the line.
     */
    BharatMapsLineJoinRound,
    /**
     A join with a sharp, angled corner which is drawn with the outer sides
     beyond the endpoint of the path until they meet.
     */
    BharatMapsLineJoinMiter,
};

/**
 Controls the frame of reference for
 ``BharatMapsLineStyleLayer/lineTranslation``.

 Values of this type are used in the ``BharatMapsLineStyleLayer/lineTranslationAnchor``
 property.
 */
typedef NS_ENUM(NSUInteger, BharatMapsLineTranslationAnchor) {
    /**
     The line is translated relative to the map.
     */
    BharatMapsLineTranslationAnchorMap,
    /**
     The line is translated relative to the viewport.
     */
    BharatMapsLineTranslationAnchorViewport,
};

/**
 An ``BharatMapsLineStyleLayer`` is a style layer that renders one or more
 stroked polylines on the map.
 ...
 ``BharatMapsLineStyleLayer`` object, or they can be
 ``BharatMapsLineStyleLayer``, ``BharatMapsLineStyleLayer``,
 ``BharatMapsLineStyleLayer``, or ``BharatMapsLineStyleLayer`` instances in an
 ``BharatMapsLineStyleLayer`` or ``BharatMapsLineStyleLayer`` object.
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsLineStyleLayer : BharatMapsVectorStyleLayer
 ...
 * Constant `BharatMapsLineCap` values
 ...
 * Constant `BharatMapsLineJoin` values
 * Any of the following constant string values:
...
*/
@property (nonatomic) BharatMapsTransition lineBlurTransition;
...
*/
@property (nonatomic) BharatMapsTransition lineColorTransition;
...
*/
@property (nonatomic) BharatMapsTransition lineDashPatternTransition;
...
*/
@property (nonatomic) BharatMapsTransition lineGapWidthTransition;

#if TARGET_OS_IPHONE
/**
 The color gradient with which the line will be drawn. This property only has an
 effect on lines defined by an ``BharatMapsShapeSource`` whose
 ``BharatMapsShapeSource`` option is set to `YES`.
...
*/
@property (nonatomic) BharatMapsTransition lineOffsetTransition;
...
*/
@property (nonatomic) BharatMapsTransition lineOpacityTransition;
...
*/
@property (nonatomic) BharatMapsTransition linePatternTransition;
...
*/
@property (nonatomic) BharatMapsTransition lineTranslationTransition;
 ...
 * Constant `BharatMapsLineTranslationAnchor` values
 * Any of the following constant string values:
...
*/
@property (nonatomic) BharatMapsTransition lineWidthTransition;

@end

/**
 Methods for wrapping an enumeration value for a style layer attribute in an
 ``BharatMapsLineStyleLayer`` object and unwrapping its raw value.
 */
@interface NSValue (BharatMapsLineStyleLayerAdditions)

// MARK: Working with Line Style Layer Attribute Values

/**
 Creates a new value object containing the given `BharatMapsLineCap` enumeration.

 @param lineCap The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithBharatMapsLineCap:(BharatMapsLineCap)lineCap;

/**
 The ``BharatMapsLineCap`` enumeration representation of the value.
 */
@property (readonly) BharatMapsLineCap BharatMapsLineCapValue;

/**
 Creates a new value object containing the given `BharatMapsLineJoin` enumeration.

 @param lineJoin The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithBharatMapsLineJoin:(BharatMapsLineJoin)lineJoin;

/**
 The ``BharatMapsLineJoin`` enumeration representation of the value.
 */
@property (readonly) BharatMapsLineJoin BharatMapsLineJoinValue;

/**
 Creates a new value object containing the given `BharatMapsLineTranslationAnchor` enumeration.

 @param lineTranslationAnchor The value for the new object.
 @return A new value object that contains the enumeration value.
 */
+ (instancetype)valueWithBharatMapsLineTranslationAnchor:(BharatMapsLineTranslationAnchor)lineTranslationAnchor;

/**
 The ``BharatMapsLineTranslationAnchor`` enumeration representation of the value.
 */
@property (readonly) BharatMapsLineTranslationAnchor BharatMapsLineTranslationAnchorValue;
