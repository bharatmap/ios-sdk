...
/**
 The ``BharatMapsAnnotationImage`` class is responsible for presenting point-based
 ...
 as a marker using ``BharatMapsAnnotationImage``.
 */
BharatMaps_EXPORT
@interface BharatMapsAnnotationImage : NSObject <NSSecureCoding>
