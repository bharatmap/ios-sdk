...
@class BharatMapsAttributedExpression;

NS_ASSUME_NONNULL_BEGIN

typedef NSString *BharatMapsExpressionInterpolationMode NS_TYPED_ENUM;
...
+ (instancetype)mgl_expressionForConditional:(nonnull NSPredicate *)conditionPredicate
    ...
    NS_SWIFT_NAME(init(forBharatMapsConditional:trueExpression:falseExpression:));
...
+ (instancetype)mgl_expressionForSteppingExpression:(nonnull NSExpression *)steppingExpression
    ...
    NS_SWIFT_NAME(init(forBharatMapsStepping:from:stops:));
...
/**
 ...
 @param curveType The curve type could be ``BharatMapsExpressionInterpolationModeLinear``,
 ``BharatMapsExpressionInterpolationModeExponential`` and
 ``BharatMapsExpressionInterpolationModeCubicBezier``.
 @param parameters The parameters expression.
 @param stops The stops expression.

 #### Related examples
 TODO: Create a heatmap layer, learn how to style an ``BharatMapsHeatmapStyleLayer``
...
+ (instancetype)mgl_expressionForInterpolatingExpression:(nonnull NSExpression *)inputExpression
                                           withCurveType:
                                               (nonnull BharatMapsExpressionInterpolationMode)curveType
                                              parameters:(nullable NSExpression *)parameters
                                                   stops:(nonnull NSExpression *)stops
    NS_SWIFT_NAME(init(forBharatMapsInterpolating:curveType:parameters:stops:));
...
+ (instancetype)mgl_expressionForMatchingExpression:(nonnull NSExpression *)inputExpression
    ...
    NS_SWIFT_NAME(init(forBharatMapsMatchingKey:in:default:));

/**
 Returns an attributed function expression specifying an ``BharatMapsAttributedExpression`` constant
 expression array.

 @param attributedExpressions The ``BharatMapsAttributedExpression`` constant expression array.
 */
 ...
 */
+ (instancetype)expressionWithBharatMapsJSONObject:(id)object NS_SWIFT_NAME(init(mglJSONObject:));
