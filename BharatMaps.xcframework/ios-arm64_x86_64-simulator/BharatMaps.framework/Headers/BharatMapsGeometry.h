...
/** Defines the area spanned by an ``BharatMapsCoordinateBounds``. */
typedef struct __attribute__((objc_boxable)) BharatMapsCoordinateSpan {
  /** Latitudes spanned by an ``BharatMapsCoordinateBounds``. */
  CLLocationDegrees latitudeDelta;
  /** Longitudes spanned by an ``BharatMapsCoordinateBounds``. */
  CLLocationDegrees longitudeDelta;
} BharatMapsCoordinateSpan;

/* Defines a point on the map in Mercator projection for a specific zoom level. */
typedef struct __attribute__((objc_boxable)) BharatMapsMapPoint {
...
typedef struct BharatMapsMatrix4 {
...
/**
 Creates a new ``BharatMapsCoordinateSpan`` from the given latitudinal and longitudinal
 deltas.
 */
NS_INLINE BharatMapsCoordinateSpan BharatMapsCoordinateSpanMake(CLLocationDegrees latitudeDelta,
                                                  CLLocationDegrees longitudeDelta) {
  BharatMapsCoordinateSpan span;
...
/**
 Creates a new ``BharatMapsMapPoint`` from the given X and Y coordinates, and zoom level.
 */
NS_INLINE BharatMapsMapPoint BharatMapsMapPointMake(CGFloat x, CGFloat y, CGFloat zoomLevel) {
  BharatMapsMapPoint point;
  point.x = x;
  point.y = y;
 ...
 */
NS_INLINE BOOL BharatMapsCoordinateSpanEqualToCoordinateSpan(BharatMapsCoordinateSpan span1,
                                                      BharatMapsCoordinateSpan span2) {
...
FOUNDATION_EXTERN BharatMaps_EXPORT const BharatMapsCoordinateSpan BharatMapsCoordinateSpanZero;

/** A rectangular area as measured on a two-dimensional map projection. */
typedef struct __attribute__((objc_boxable)) BharatMapsCoordinateBounds {
  /** Coordinate at the southwest corner. */
  CLLocationCoordinate2D sw;
  /** Coordinate at the northeast corner. */
  CLLocationCoordinate2D ne;
} BharatMapsCoordinateBounds;

/**
 A quadrilateral area as measured on a two-dimensional map projection.
 ``BharatMapsCoordinateQuad`` differs from ``BharatMapsCoordinateQuad`` in that it allows
 ...
 */
typedef struct BharatMapsCoordinateQuad {
...
} BharatMapsCoordinateQuad;

/**
 Creates a new ``BharatMapsCoordinateBounds`` structure from the given southwest and
 northeast coordinates.
 */
NS_INLINE BharatMapsCoordinateBounds BharatMapsCoordinateBoundsMake(CLLocationCoordinate2D sw,
                                                      CLLocationCoordinate2D ne) {
  BharatMapsCoordinateBounds bounds;
  bounds.sw = sw;
  bounds.ne = ne;
  return bounds;
}
...
/**
 Creates a new ``BharatMapsCoordinateQuad`` structure from the given top left,
  bottom left, bottom right, and top right coordinates.
 */
NS_INLINE BharatMapsCoordinateQuad BharatMapsCoordinateQuadMake(CLLocationCoordinate2D topLeft,
                                                  CLLocationCoordinate2D bottomLeft,
                                                  CLLocationCoordinate2D bottomRight,
                                                  CLLocationCoordinate2D topRight) {
  BharatMapsCoordinateQuad quad;
...
/**
 Creates a new ``BharatMapsCoordinateQuad`` structure from the given ``BharatMapsCoordinateQuad``.
 The returned quad uses the bounds' northeast coordinate as the top right, and the
  southwest coordinate at the bottom left.
 */
NS_INLINE BharatMapsCoordinateQuad BharatMapsCoordinateQuadFromCoordinateBounds(BharatMapsCoordinateBounds bounds) {
  BharatMapsCoordinateQuad quad;
...
NS_INLINE BOOL BharatMapsCoordinateBoundsEqualToCoordinateBounds(BharatMapsCoordinateBounds bounds1,
                                                          BharatMapsCoordinateBounds bounds2) {
  return (
...
NS_INLINE BOOL BharatMapsCoordinateBoundsIntersectsCoordinateBounds(BharatMapsCoordinateBounds bounds1,
                                                             BharatMapsCoordinateBounds bounds2) {
...
/**
 ...
 ``BharatMapsCoordinateInCoordinateBounds`` to determine if a point is within, or
 intersects, a given bounding box.
 */
NS_INLINE BOOL BharatMapsCoordinateInCoordinateBounds(CLLocationCoordinate2D coordinate,
                                               BharatMapsCoordinateBounds bounds) {
...
NS_INLINE BharatMapsCoordinateSpan BharatMapsCoordinateBoundsGetCoordinateSpan(BharatMapsCoordinateBounds bounds) {
  return BharatMapsCoordinateSpanMake(bounds.ne.latitude - bounds.sw.latitude,
 ...
 */
NS_INLINE BharatMapsCoordinateBounds BharatMapsCoordinateBoundsOffset(BharatMapsCoordinateBounds bounds,
                                                        BharatMapsCoordinateSpan offset) {
  BharatMapsCoordinateBounds offsetBounds = bounds;
 ...
 */
NS_INLINE BOOL BharatMapsCoordinateBoundsIsEmpty(BharatMapsCoordinateBounds bounds) {
  BharatMapsCoordinateSpan span = BharatMapsCoordinateBoundsGetCoordinateSpan(bounds);
  return span.latitudeDelta == 0 || span.longitudeDelta == 0;
}

/** Returns a formatted string for the given coordinate bounds. */
NS_INLINE NSString *BharatMapsStringFromCoordinateBounds(BharatMapsCoordinateBounds bounds) {
...
NS_INLINE NSString *BharatMapsStringFromCoordinateQuad(BharatMapsCoordinateQuad quad) {
...
NS_INLINE CGFloat BharatMapsRadiansFromDegrees(CLLocationDegrees degrees) {
  return (CGFloat)(degrees * M_PI) / 180;
}

/** Returns degrees, converted from radians. */
NS_INLINE CLLocationDegrees BharatMapsDegreesFromRadians(CGFloat radians) { return radians * 180 / M_PI; }

/** Returns Mercator projection of a WGS84 coordinate at the specified zoom level. */
FOUNDATION_EXTERN BharatMaps_EXPORT BharatMapsMapPoint BharatMapsMapPointForCoordinate(CLLocationCoordinate2D coordinate,
                                                                  double zoomLevel);
...
FOUNDATION_EXTERN BharatMaps_EXPORT CLLocationDistance BharatMapsAltitudeForZoomLevel(double zoomLevel,
                                                                        CGFloat pitch,
...
FOUNDATION_EXTERN BharatMaps_EXPORT double BharatMapsZoomLevelForAltitude(CLLocationDistance altitude,
                                                            CGFloat pitch,
                                                            CLLocationDegrees latitude,
                                                            CGSize size);
