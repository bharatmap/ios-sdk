...
/**
 The ``BharatMapsCoordinateFormatter`` class provides properly formatted descriptions of
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsCoordinateFormatter : NSFormatter
...
/**
 This method is not supported for the ``BharatMapsCoordinateFormatter`` class.
 */
