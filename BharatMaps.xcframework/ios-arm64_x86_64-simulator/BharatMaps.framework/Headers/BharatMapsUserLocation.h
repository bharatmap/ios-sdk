...
/**
 The BharatMapsUserLocation class defines a specific type of annotation that identifies
 the user’s current location. You do not create instances of this class
 directly. Instead, you retrieve an existing ``BharatMapsUserLocation`` object from the
 ...
 */
BharatMaps_EXPORT
@interface BharatMapsUserLocation : NSObject <BharatMapsAnnotation, NSSecureCoding>
...
/**
 ...
 ``BharatMapsUserTrackingMode/BharatMapsUserTrackingModeFollowWithHeading`` or if
 ``BharatMapsMapView/showsUserHeadingIndicator`` is disabled.
 */
